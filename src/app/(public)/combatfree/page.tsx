...
import { CombatFreeMessage } from '@/components/combatfree/combatfree-message'
import { Button } from '@/components/ui/button'
import { Textarea } from '@/components/ui/textarea'
import { Send, Loader2, Trash2, ArrowLeft, Swords, Sparkles } from 'lucide-react'
import { cn } from '@/lib/utils'

const AGENTS_LIST: FreeAgentId[] = ['spark', 'lens', 'radar', 'devil']

export default function PublicCombatFreePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex flex-col">
      {/* Header */}
      <header className="border-b border-slate-700/50 px-4 py-3 flex items-center justify-between bg-slate-900/80 backdrop-blur-sm sticky top-0 z-50">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button asChild size="sm" className="bg-gradient-to-r from-cyan-500 to-purple-500 hover:from-cyan-600 hover:to-purple-600">
            <Link href="/signup">
            ...
            <div className="flex justify-center">
              <div className="max-w-xl p-6 rounded-xl bg-slate-800/30 border border-slate-700/30 text-center">
                <div className="text-4xl mb-4">
                  <Swords className="w-12 h-12 text-green-400 mx-auto" />
                </div>
                <h2 className="text-xl font-semibold text-white mb-2">
                  Combat Free - Hội đồng 4 AI Miễn phí
                </h2>
                <p className="text-slate-400 mb-4">
                  Chat với 4 AI agents hoàn toàn miễn phí! Không cần đăng nhập.
                </p>
                ...
                <div className="pt-4 border-t border-slate-700/30">
                  <p className="text-sm text-slate-500 mb-3">
                    Đăng ký để truy cập Combat Pro với 4 AI mạnh hơn
                  </p>
